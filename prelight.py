...
def CR(im_ori, im_log, alpha=64., gain=1., offset=0.):
    im_cr = im_log * gain * (
...
if __name__ == '__main__':
    rootpath = '/home/zhuofei/linux_data/yjh/input/'
    outpath = '/home/zhuofei/linux_data/yjh/predata/'
    filenames = os.listdir(rootpath)
    for filename in filenames:
        imagepath = rootpath + filename
        outimgpath = outpath + filename
        ...
        im_out = MSRCR(imagepath, args.s, args.n, args.d, not args.no_cr)
        print("图像" + filename + "处理完成！")
        cv2.imwrite(outimgpath, im_out[:, :, (2, 1, 0)])